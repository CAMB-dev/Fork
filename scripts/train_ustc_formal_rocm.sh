...
WORKSPACE="${WORKSPACE:-.}"
TRAIN_PATH="${TRAIN_PATH:-data/processed/ustc_tfc2016/split_label_stratified/train.parquet}"
VAL_PATH="${VAL_PATH:-data/processed/ustc_tfc2016/split_label_stratified/val.parquet}"
TEST_PATH="${TEST_PATH:-data/processed/ustc_tfc2016/split_label_stratified/test.parquet}"
OUTPUT_ROOT="${OUTPUT_ROOT:-artifacts/ustc_formal_rocm}"
...
CLASSIFIER_BATCH_SIZE="${CLASSIFIER_BATCH_SIZE:-4}"
MLM_EPOCHS="${MLM_EPOCHS:-1}"
MLM_BATCH_SIZE="${MLM_BATCH_SIZE:-4}"
RESUME="${RESUME:-0}"
