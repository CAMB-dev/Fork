...
| --- | --- | --- |
| `fig_4_1_training_macro_f1_curve.png` | 4.1 | Low-learning-rate validation macro-F1 convergence over five supervised epochs; epoch 5 is selected as the best checkpoint. |
